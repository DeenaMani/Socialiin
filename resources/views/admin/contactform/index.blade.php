                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class=" justify-content-center">
                                         <a href="{{ url('admin/contactform/'.$data->id.'/show') }}" class=" btn btn-primary">show</i></a>
                                    </td>
                                    <td class="row justify-content-center"> 
                                       <!--  <a href="{{ url('admin/contactform/'.$data->id.'/edit') }}" class=" btn btn-primary"><i class="fa-solid fa-pen-to-square"></i></a> -->
