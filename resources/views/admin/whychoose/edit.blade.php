                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <img src="{{url('/public/image/whychoose/'.$whychoose->whychoose_image)}}" width="50px"> <br> 
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <label for="whychoose_sub_title">Sub Title </label>
                                            <input type="Text" class="form-control mb-4" name="whychoose_sub_title"value="{{$whychoose->whychoose_sub_title}}" >
                                        </div>
