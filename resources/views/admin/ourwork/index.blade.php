                ...
                <div class="row align-items-center">
                    <div class="col-sm-5 col-xl-6">
                        <div class="page-title">
                            <h2 class="mb-1 font-weight-bold text-white">Our Work</h2>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                <div class="card ">
                    ...
                    <div>
                        ...
                        <div class="col-lg-3">
                           <a href="{{url('admin/ourwork/create')}}" class="btn btn-primary me-5" style="float:right;"> Add <i class="bx bx-plus"></i></a> 
                        </div>
                    </div>                
                    ...
                    <div class="card-body">
                        ...
                        @foreach ($result as $key => $data)
                            <tbody>
                                <tr>
                                    <td> {{$data->id}} </td>
                                    <td> <img src="{{url('/public/image/ourwork/'.$data->ourwork_image)}}" width="50px"> </td>
                                    <td> {{$data->ourwork_title}} </td>
                                    <td> <div class="form-check form-switch">
                                      ...
                                      <td class="row justify-content-center"> 
                                        <a href="{{ url('admin/ourwork/'.$data->id.'/edit') }}" class=" btn btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                                          <form action="{{ url('admin/ourwork/'.$data->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
...
<script type="text/javascript">
  ...
  $(document).on("change",".toggle-class",function() {
      ...
      //alert(id);
      $.ajax({
          url: "{{URL('/')}}/admin/ourwork/status/" + id + "/" +status ,
              success: function(e) {
          }
      });
  });
