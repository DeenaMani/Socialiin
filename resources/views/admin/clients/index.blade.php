                     ...
                     @include('layouts.partials.messages')
                        ...
                        @foreach ($result as $key => $data)
                            <tbody>
                                <tr>
                                    <td> {{$data->id}} </td>
                                    <td>  <img src="{{url('/public/image/clients/'.$data->client_image)}}" width="50px"> </td>
                                    ...
                                    <td class="d-flex justify-content-center"> 
                                        <a href="{{ url('admin/client/'.$data->id.'/edit') }}" class=" btn btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
