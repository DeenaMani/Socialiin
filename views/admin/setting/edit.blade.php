                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    ...
                                    <img src="{{url('public/images/'.$setting->logo)}}" width="50px"> <br>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <img src="{{url('public/images/'.$setting->fav_icon)}}" width="50px"> <br>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="col-lg-12">
                             ...
                             <div class="col-lg-12">
                                <div class="row">
                                    <label for="whatsapp"> Whatsapp_link </label>
                                    <input type="text" class="form-control mb-4" name="Whatsapp" value="{{$setting->whatsapp}}" required>
                                </div>
                            </div>
