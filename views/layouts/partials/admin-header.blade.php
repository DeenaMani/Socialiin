            ...
            <div class="left-bar">
               <div class="navbar-brand-box">
                  <a href="{{url('admin/')}}" class="logo logo-dark">
                     <span class="logo-sm"><img src="{{url('/public/images/'.$setting->logo)}}" alt="{{$setting->company_name}}"></span>
                     <span class="logo-lg"><img src="{{url('/public/images/'.$setting->logo)}}" alt="{{$setting->company_name}}"></span>
                  </a>
